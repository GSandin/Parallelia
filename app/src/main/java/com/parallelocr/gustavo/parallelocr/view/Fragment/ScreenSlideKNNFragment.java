 ...
 */
public class ScreenSlideKNNFragment extends Fragment {
     ...
     * @return a new page
     */
    public static ScreenSlideKNNFragment newInstance(int color, int index) {

        // Instantiate a new fragment
        ScreenSlideKNNFragment fragment = new ScreenSlideKNNFragment();
