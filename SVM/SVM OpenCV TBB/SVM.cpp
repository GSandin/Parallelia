...
int main(int argc, const char** argv){
	...
	CvSVMParams params(CvSVM::C_SVC, CvSVM::LINEAR, 0, 5.383, 0, 2.67, 0, 0, 0, cvTermCriteria( CV_TERMCRIT_ITER+CV_TERMCRIT_EPS, 1000, FLT_EPSILON ) );
	CvSVM svm(train_final, trainClasses, idx, sampleIdx, params);
	...
	svm.predict(test_final, results);

	end = clock();

	cout<<"SVM tested"<<endl;
